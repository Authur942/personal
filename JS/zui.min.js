    ...
    o.prototype.toggle = function (t, e) {
        ...
        if (i === e && (i = s.position), i !== e && null !== i) {
            ...
            if ("fit" === i ? i = {
                ...
                var u = null,
                    f = s.rememberPos;
                f && (f === !0 ? u = o.$element.data("modal-pos") : t.zui.store && (u = t.zui.store.pageGet(n + ".rememberPos." + f))), i = t.extend(i, {
...
function (t, e, i) {
    ...
    r.DEFAULTS = {
        ...
        var r = this;
        if (i.url && (!i.type || i.type != o && "iframe" != i.type) && (i.type = o), i.remote) i.type = o, typeof i.remote === s && (i.url = i.remote);
